...
VISCOUS_RESISTANCE  = 1e8    # 1/m^2
INERTIAL_RESISTANCE = 5000   # 1/m


COOLING_HEAT_SINK   = -5e5   # W/m^3
...
def Setup(
    ...
    try:
        ...
        general.solver.two_dim_space.set_state("axisymmetric")
        ...
        outlet.thermal.backflow_total_temperature.value = 1100  # backflow temperature
...
if __name__ == "__main__":
    ...
    mesh_file = os.path.join(directory, "geometria.msh.h5")
